  ...
  build: {
    rollupOptions: {
      input: {
        ...
        toolSlugGenerator: resolve(root, "tools/slug-generator.html"),
        toolCaseConverter: resolve(root, "tools/case-converter.html"),
        toolUtmLinkBuilder: resolve(root, "tools/utm-link-builder.html"),
